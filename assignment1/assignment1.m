...
%
% Answer: for and while loops. a for loop run for a specified number of
% times and a while loop runs as long a condition is true
% 
...
%
% Answer: Not a Number. you would get it if you tried dividing a number by
% 0 ex. 0/0
%
...
totalRevenues = input('input total revenues');
totalCosts = input('input total costs');
